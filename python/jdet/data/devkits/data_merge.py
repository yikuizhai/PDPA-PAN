...
def data_merge_result(result_pkl,work_dir,epoch,name,dataset_type,images_dir=""):
    assert dataset_type in ["FAIR", "DOTA", "DOTA1_5", "DOTA2", "FAIR1M_1_5", "RS2022", "Single", "vehicle1","vehicle2","vehicle3","vehicle4", "vehicle5"], "need to set dataset.test.dataset_type in the config file. FAIR, FAIR1M_1_5, DOTA, DOTA1_5, RS2022 and DOTA2 are supported"
    print("Merge results...")

...
class RS2022Dataset(CustomDataset):
    def __init__(self, *arg, balance_category=False, **kwargs):
        self.CLASSES = get_classes_by_name("RS2022")
    ...
    def _balance_categories(self):
        ...
        balance_dict = {
            ...
            "Football_Field": (1, 962),
            "Baseball_Field": (2, 202)
        }
...
def test_eval():
    ...
    results = jt.load("/home/jackychou/base_project/JDet-master/datasets/2048_check_data/trainval_2048_512_1.0/labels.pkl")
    # results = results
    dataset = RS2022Dataset(
        annotations_file='/home/jackychou/base_project/JDet-master/datasets/2048_check_data/trainval_2048_512_1.0/labels.pkl',
        images_dir='/home/jackychou/base_project/JDet-master/datasets/2048_check_data/trainval_2048_512_1.0/images')

...
__all__ = ["ORConv2d","RotationInvariantPooling", "RotationInvariantPooling_LN"]
...
class RotationInvariantPooling_gn(nn.Module):
    def __init__(self, nInputPlane, nOrientation=8):
        super(RotationInvariantPooling_gn, self).__init__()
        self.nInputPlane = nInputPlane
        self.nOrientation = nOrientation
        #TODO remove this
        hiddent_dim = int(nInputPlane / nOrientation)
